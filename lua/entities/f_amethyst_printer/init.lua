...
function ENT:Initialize()
	...
	self:SetColor( fprinters.config.amethystcolor )
	...
	self.yaniyor = false
	timer.Simple(fprinters.config.amethystprinttime, function() if IsValid(self) then yaratulan(self) end end)
...
function ENT:ParaYarat()
	...
	local printamount = fprinters.config.amethystprintamount
	local printtime = fprinters.config.amethystprinttime
