...
function ENT:Initialize()
	...
	self:SetColor( fprinters.config.sapphirecolor )
	...
	self.yaniyor = false
	timer.Simple(fprinters.config.sapphireprinttime, function() if IsValid(self) then yaratulan(self) end end)
...
function ENT:ParaYarat()
	...
	local printamount = fprinters.config.sapphireprintamount
	local printtime = fprinters.config.sapphireprinttime
