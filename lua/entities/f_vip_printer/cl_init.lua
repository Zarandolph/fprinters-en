...
function ENT:Draw()
	...
	elseif ( self:GetMoney()>=100000 ) then
		...
		surface.DrawTexturedRect(100, 95 , 32, 32)
	...
	cam.Start3D2D( Pos + KarsidanAng:Up() * 16.9, KarsidanAng, 0.109 )
		...
		draw.KarsidanOrtaliYazi( 133, 60, "KucukFont", fprinters.config.vipname)
...
function ENT:Think()
		...
		halo.Add(enttable, fprinters.config.vipglowcolor, 2, 2, 5 )

end

hook.Add( "PreDrawHalos", "DRAWIT", function() 
