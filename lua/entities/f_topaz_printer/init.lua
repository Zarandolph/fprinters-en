...
function ENT:Initialize()
	...
	self:SetColor( fprinters.config.topazcolor )
	...
	self.yaniyor = false
	timer.Simple(fprinters.config.topazprinttime, function() if IsValid(self) then yaratulan(self) end end)
...
function ENT:ParaYarat()
	...
	local printamount = fprinters.config.topazprintamount
	local printtime = fprinters.config.topazprinttime
