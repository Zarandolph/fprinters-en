...
function ENT:Initialize()
	...
	self:SetColor( fprinters.config.emeraldcolor )
	...
	self.yaniyor = false
	timer.Simple(fprinters.config.emeraldprinttime, function() if IsValid(self) then yaratulan(self) end end)
...
function ENT:ParaYarat()
	...
	local printamount = fprinters.config.emeraldprintamount
	local printtime = fprinters.config.emeraldprinttime
